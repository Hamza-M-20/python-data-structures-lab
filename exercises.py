...
def create_awesome_students():
    ...
    awesome_students = f"['Tina is awesome!, 'Fred is awesome!', 'Wilma is awesome!']"
...
def filter_foods_with_a():
    foods = ('pizza', 'shrimps', 'pasta')
    foods_with_an_a = filter(lambda food: 'a' in food, foods)
    print(list(foods_with_an_a))
